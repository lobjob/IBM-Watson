...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(filtered_df.groupby('class', as_index=False)['Launch Site'].count(),
        values='Launch Site',
        names='class',
...
def get_scatter_chart(entered_site, entered_payload):
    ...
    if entered_site == 'ALL':
        ...
        min, max = entered_payload
        mask = (filtered_df['Payload Mass (kg)'] > min) & (filtered_df['Payload Mass (kg)'] < max)
